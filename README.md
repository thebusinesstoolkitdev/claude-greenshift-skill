...
Claude Code picks it up automatically. Ask for a build in plain language, *"recreate
...
This skill is an independent pipeline built on that format. It is not affiliated with or
endorsed by WPsoul.
